...
class BasicTopo(Topo):
    ...
    def build(self, **_opts):
        router = self.addHost('r', ip='10.0.0.0', mac='10.0.0.0')
        host1 = self.addHost('h1', ip='20.0.0.0', mac='20.0.0.0', defaultRoute='via 10.1.1.254')
        host2 = self.addHost('h2', ip='20.1.1.1', mac='20.1.1.1', defaultRoute='via 10.2.2.254')
