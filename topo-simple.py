...
class SingleIPRouterTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        router = self.addHost('r', ip='10.0.0.1/32')  # Single IP for the router

        # Define hosts with specific IPs and default routes through the router's loopback IP
        host1 = self.addHost('h1', ip='10.1.1.1/24', defaultRoute='via 10.0.0.1')
        host2 = self.addHost('h2', ip='10.2.2.1/24', defaultRoute='via 10.0.0.1')

        # Connect hosts to the router
        self.addLink(host1, router, intfName1='h1-eth0', params1={'ip': '10.1.1.1/24'})
        self.addLink(host2, router, intfName2='h2-eth0', params1={'ip': '10.2.2.1/24'})
